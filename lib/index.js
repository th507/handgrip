...
function createRenderer(compiled) {
  return function*(context) {
    ...
    if (!(LAYER in context)) {
      Object.defineProperty(context, LAYER, {
        get: function () {
    ...
    return yield replace(context[Q], out, context);
  };
}
...
function createFrame (obj) {
  ...
  if (frame.root && LAYER in frame.root) {
    frame.root = frame.root[LAYER];
  }
  return frame;
}
