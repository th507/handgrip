...
suite("generator helper evaluation order", function() {
  test("evaluation order of nested helpers", function (done) {
    ...
    co(function*(){
      ...
      assert.equal(evalOrder.toString(), "pre-1,pre-1.1,post-1.1,post-1,pre-2,post-2");
    }).then(done, done);
  });
  ...
  test('evaluation order of nested generator helpers', function (done) {
    ...
    co(function*(){
      ...
      assert.equal(evalOrder.toString(), "pre-1,pre-1.1,post-1.1,pre-1.2,post-1.2,post-1,pre-2,pre-2.1,post-2.1,post-2");
    }).then(done, done);
  });
  ...
  test('evaluation order of nested generator helpers with `each` helper', function (done) {
    ...
    co(function*(){
      ...
      assert.equal(evalOrder.toString(), "pre-1,pre-1.1,post-1.1,pre-1.2,post-1.2,pre-1.3,post-1.3,post-1,pre-2,post-2");
    }).then(done, done);
  });
});
